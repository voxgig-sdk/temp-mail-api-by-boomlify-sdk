# TempMailApiByBoomlify Ruby SDK Reference

Complete API reference for the TempMailApiByBoomlify Ruby SDK.
...
#### `TempMailApiByBoomlifySDK.test(testopts = nil, sdkopts = nil)`
