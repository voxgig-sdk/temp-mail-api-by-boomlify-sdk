...
#      offline in seeded test mode (TempMailApiByBoomlifySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TempMailApiByBoomlify_sdk.rb")
  SDK_CLASS = "TempMailApiByBoomlifySDK"
  ...
  SDK_BASE = "TempMailApiByBoomlify_sdk"
