# TempMailApiByBoomlify SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # TempMailApiByBoomlifySDK.new, not TempMailApiByBoomlifySDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    TempMailApiByBoomlifySDK.new(opts)
  end
