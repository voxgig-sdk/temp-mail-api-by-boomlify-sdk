...
AQL-driven CLI and REPL for the TempMailApiByBoomlify SDK. Positional arguments are
...
```sh
go build -o temp-mail-api-by-boomlify-cli ./...
```
...
./temp-mail-api-by-boomlify-cli list domain
./temp-mail-api-by-boomlify-cli load 1 domain
./temp-mail-api-by-boomlify-cli load '{id:1}' domain
