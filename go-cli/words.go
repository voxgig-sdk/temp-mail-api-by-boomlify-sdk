...
func registerSDKWords(r *eng.Registry, client *sdk.TempMailApiByBoomlifySDK) {
...
func runOp(client *sdk.TempMailApiByBoomlifySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
