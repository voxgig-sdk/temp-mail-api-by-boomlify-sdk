...
func registerTools(server *mcp.Server, client *sdk.TempMailApiByBoomlifySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "temp-mail-api-by-boomlify_list",
		Description: "List records from TempMailApiByBoomlify. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "temp-mail-api-by-boomlify_load",
		Description: "Load a single record from TempMailApiByBoomlify. " +
...
func runOp(client *sdk.TempMailApiByBoomlifySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TempMailApiByBoomlifySDK, name string) (sdk.TempMailApiByBoomlifyEntity, error) {
