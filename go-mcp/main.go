// Command TempMailApiByBoomlify-mcp is an MCP server exposing the TempMailApiByBoomlify
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TempMailApiByBoomlify_list  — list records of an entity
//	TempMailApiByBoomlify_load  — load a single record of an entity
//
