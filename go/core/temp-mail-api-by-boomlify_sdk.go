...
type TempMailApiByBoomlifySDK struct {
	Mode     string
...
func (sdk *TempMailApiByBoomlifySDK) OptionsMap() map[string]any {
...
func (sdk *TempMailApiByBoomlifySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TempMailApiByBoomlifySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TempMailApiByBoomlifySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TempMailApiByBoomlifySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TempMailApiByBoomlifySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TempMailApiByBoomlifySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TempMailApiByBoomlifySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TempMailApiByBoomlifySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TempMailApiByBoomlifySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TempMailApiByBoomlifySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *TempMailApiByBoomlifySDK) Domain(data map[string]any) TempMailApiByBoomlifyEntity {
...
func (sdk *TempMailApiByBoomlifySDK) Email(data map[string]any) TempMailApiByBoomlifyEntity {
...
func (sdk *TempMailApiByBoomlifySDK) Inbox(data map[string]any) TempMailApiByBoomlifyEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *TempMailApiByBoomlifySDK {
	...
	sdk := NewTempMailApiByBoomlifySDK(sdkopts)
	sdk.Mode = "test"
