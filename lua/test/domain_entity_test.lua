...
describe("DomainEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TEMPMAILAPIBYBOOMLIFY_TEST_DOMAIN_ENTID JSON to run live")
      return
    end
...
function domain_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TEMPMAILAPIBYBOOMLIFY_TEST_DOMAIN_ENTID")
