...
(0, node_test_1.describe)('DomainDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TempMailApiByBoomlifySDK({
...
function liveScenariosActive() { return false && process.env.TEMP_MAIL_API_BY_BOOMLIFY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TempMailApiByBoomlifySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.TEMP_MAIL_API_BY_BOOMLIFY_APIKEY,
        }));
        let idmap = env['TEMP_MAIL_API_BY_BOOMLIFY_TEST_DOMAIN_ENTID'];
    ...
    const client = new __1.TempMailApiByBoomlifySDK({
        base: 'http://localhost:8080',
