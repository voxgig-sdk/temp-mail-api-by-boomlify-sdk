...
|---|---|---|
| `ts/` | @voxgig-sdk/temp-mail-api-by-boomlify-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/temp-mail-api-by-boomlify-sdk \
      --repository voxgig-sdk/temp-mail-api-by-boomlify-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/temp-mail-api-by-boomlify-sdk` shows it, and
`npm trust revoke @voxgig-sdk/temp-mail-api-by-boomlify-sdk --id=<id>` removes it.
