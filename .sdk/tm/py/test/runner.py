...
class TempMailApiByBoomlifyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TempMailApiByBoomlifyTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TempMailApiByBoomlifyTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TempMailApiByBoomlifyTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
