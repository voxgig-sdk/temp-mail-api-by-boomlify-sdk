...
// TempMailApiByBoomlify SDK timeout feature
...
class TempMailApiByBoomlifyTimeoutFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _with_timeout(TempMailApiByBoomlifyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TempMailApiByBoomlifyContext $_ctx, float $ms): void
    {
        $client = $this->client;
