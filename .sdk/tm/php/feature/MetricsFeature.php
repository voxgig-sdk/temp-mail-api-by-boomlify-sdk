...
// TempMailApiByBoomlify SDK metrics feature
...
class TempMailApiByBoomlifyMetricsFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _record(TempMailApiByBoomlifyContext $ctx, bool $ok): void
    {
