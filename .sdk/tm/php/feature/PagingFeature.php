...
// TempMailApiByBoomlify SDK paging feature
...
class TempMailApiByBoomlifyPagingFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _is_list(TempMailApiByBoomlifyContext $ctx): bool
    {
