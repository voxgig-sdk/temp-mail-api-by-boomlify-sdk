...
// TempMailApiByBoomlify SDK proxy feature
...
class TempMailApiByBoomlifyProxyFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    public function init(TempMailApiByBoomlifyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TempMailApiByBoomlifyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
