...
// TempMailApiByBoomlify SDK debug feature
...
class TempMailApiByBoomlifyDebugFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _finish(TempMailApiByBoomlifyContext $ctx, bool $ok): void
    {
