...
// TempMailApiByBoomlify SDK pipeline test
//
...
{
    private static function utility(): TempMailApiByBoomlifyUtility
    {
        return new TempMailApiByBoomlifyUtility();
    }
    ...
    private static function ctx(array $over = []): TempMailApiByBoomlifyContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TempMailApiByBoomlifyContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TempMailApiByBoomlifyOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TempMailApiByBoomlifyError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TempMailApiByBoomlifyOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TempMailApiByBoomlifyMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TempMailApiByBoomlifyOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TempMailApiByBoomlifyMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TempMailApiByBoomlifyOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TempMailApiByBoomlifyMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TempMailApiByBoomlifySpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TempMailApiByBoomlifyMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TempMailApiByBoomlifyResponse([]),
            'result' => new TempMailApiByBoomlifyResult([]),
        ]);
        [, $err] = TempMailApiByBoomlifyMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TempMailApiByBoomlifySpec([]),
            'response' => null,
            'result' => new TempMailApiByBoomlifyResult([]),
        ]);
        [, $err] = TempMailApiByBoomlifyMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TempMailApiByBoomlifySpec(['step' => 's']),
            'response' => new TempMailApiByBoomlifyResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TempMailApiByBoomlifyResult([]),
        ]);
        [, $err] = TempMailApiByBoomlifyMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TempMailApiByBoomlifySpec(['step' => 's']),
            'response' => new TempMailApiByBoomlifyResponse(self::resp(200, ['v' => 1])),
            'result' => new TempMailApiByBoomlifyResult([]),
        ]);
        [, $err] = TempMailApiByBoomlifyMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TempMailApiByBoomlifySpec(['step' => 's']),
            'response' => new TempMailApiByBoomlifyResponse(self::resp(200, ['v' => 2])),
            'result' => new TempMailApiByBoomlifyResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TempMailApiByBoomlifyMakeResponse::call($ctx);
    ...
    {
        $preset = new TempMailApiByBoomlifyResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TempMailApiByBoomlifySpec([]),
            'response' => new TempMailApiByBoomlifyResponse([]),
            'result' => new TempMailApiByBoomlifyResult([]),
        ...
        [$got, $err] = TempMailApiByBoomlifyMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TempMailApiByBoomlifyResult([])]);
        [, $err] = TempMailApiByBoomlifyMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TempMailApiByBoomlifySpec([]), 'result' => null]);
        [, $err] = TempMailApiByBoomlifyMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TempMailApiByBoomlifySpec(['step' => 's']),
            'result' => new TempMailApiByBoomlifyResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TempMailApiByBoomlifyOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TempMailApiByBoomlifyMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TempMailApiByBoomlifySpec(['step' => 's']),
            'result' => new TempMailApiByBoomlifyResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TempMailApiByBoomlifyOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TempMailApiByBoomlifyMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TempMailApiByBoomlifyResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TempMailApiByBoomlifySpec([]),
            'result' => new TempMailApiByBoomlifyResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TempMailApiByBoomlifyMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TempMailApiByBoomlifyMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TempMailApiByBoomlifyError('boom', 'boom');
        $utility->fetcher = function (TempMailApiByBoomlifyContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TempMailApiByBoomlifySpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TempMailApiByBoomlifyMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TempMailApiByBoomlifyContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TempMailApiByBoomlifyMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TempMailApiByBoomlifyResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TempMailApiByBoomlifyMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TempMailApiByBoomlifyContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TempMailApiByBoomlifySpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TempMailApiByBoomlifyMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TempMailApiByBoomlifyResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TempMailApiByBoomlifySpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TempMailApiByBoomlifyMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TempMailApiByBoomlifyMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TempMailApiByBoomlifyMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TempMailApiByBoomlifyResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TempMailApiByBoomlifyDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TempMailApiByBoomlifyResult(['ok' => false])]);
        $this->expectException(TempMailApiByBoomlifyError::class);
        TempMailApiByBoomlifyDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TempMailApiByBoomlifyResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TempMailApiByBoomlifyMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TempMailApiByBoomlifyMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TempMailApiByBoomlifyBaseFeature();
        $b = new TempMailApiByBoomlifyBaseFeature();
        TempMailApiByBoomlifyFeatureAdd::call($ctx, $a);
        TempMailApiByBoomlifyFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TempMailApiByBoomlifyBaseFeature
    {
        $f = new TempMailApiByBoomlifyBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TempMailApiByBoomlifyFeatureAdd::call($ctx, self::named_feature('a'));
        TempMailApiByBoomlifyFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        TempMailApiByBoomlifyFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        TempMailApiByBoomlifyFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        TempMailApiByBoomlifyFeatureAdd::call($ctx, $replace);
        ...
        TempMailApiByBoomlifyFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): TempMailApiByBoomlifyContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TempMailApiByBoomlifySpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TempMailApiByBoomlifyPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        TempMailApiByBoomlifyPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TempMailApiByBoomlifyResponse(['headers' => null]),
            'result' => new TempMailApiByBoomlifyResult([]),
        ]);
        TempMailApiByBoomlifyResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TempMailApiByBoomlifyResultBody::call($ctx);
