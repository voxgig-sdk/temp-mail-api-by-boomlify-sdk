...
// TempMailApiByBoomlify SDK utility type

class TempMailApiByBoomlifyUtility
{
    ...
    public static function copy(TempMailApiByBoomlifyUtility $src): TempMailApiByBoomlifyUtility
    {
        $u = new TempMailApiByBoomlifyUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
