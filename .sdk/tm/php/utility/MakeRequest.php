...
// TempMailApiByBoomlify SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TempMailApiByBoomlifyMakeRequest
{
    public static function call(TempMailApiByBoomlifyContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TempMailApiByBoomlifyResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TempMailApiByBoomlifyResponse($fetched);
        } else {
