...
// TempMailApiByBoomlify SDK utility: graphql
//
...
class TempMailApiByBoomlifyGraphql
{
    ...
    // equivalent.
    public static function body(TempMailApiByBoomlifyContext $ctx): mixed
    {
    ...
    public static function errors(TempMailApiByBoomlifyContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
