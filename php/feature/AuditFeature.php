...
// TempMailApiByBoomlify SDK audit feature
...
class TempMailApiByBoomlifyAuditFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _emit(TempMailApiByBoomlifyContext $ctx, string $outcome): void
    {
