...
// TempMailApiByBoomlify SDK streaming feature
...
class TempMailApiByBoomlifyStreamingFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _iterate(TempMailApiByBoomlifyResult $result): \Generator
    {
    ...
    private function _streamable(TempMailApiByBoomlifyContext $ctx): bool
    {
