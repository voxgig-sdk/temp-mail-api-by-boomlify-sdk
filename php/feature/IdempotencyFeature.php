...
// TempMailApiByBoomlify SDK idempotency feature
...
class TempMailApiByBoomlifyIdempotencyFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _mutating(TempMailApiByBoomlifyContext $ctx): bool
    {
