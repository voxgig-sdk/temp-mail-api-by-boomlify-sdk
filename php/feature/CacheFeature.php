...
// TempMailApiByBoomlify SDK cache feature
...
class TempMailApiByBoomlifyCacheFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _through(TempMailApiByBoomlifyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
