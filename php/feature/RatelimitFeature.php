...
// TempMailApiByBoomlify SDK ratelimit feature
...
class TempMailApiByBoomlifyRatelimitFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _acquire(TempMailApiByBoomlifyContext $ctx): void
    {
    ...
    private function _track(TempMailApiByBoomlifyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
