...
// TempMailApiByBoomlify SDK telemetry feature
...
class TempMailApiByBoomlifyTelemetryFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _close(TempMailApiByBoomlifyContext $ctx, bool $ok): void
    {
