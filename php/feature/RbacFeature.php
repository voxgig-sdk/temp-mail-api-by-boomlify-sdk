...
// TempMailApiByBoomlify SDK rbac feature
...
class TempMailApiByBoomlifyRbacFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _required(TempMailApiByBoomlifyContext $ctx): ?string
    {
    ...
    private function _reject(TempMailApiByBoomlifyContext $ctx, string $required): void
    {
    ...
    private function _track(TempMailApiByBoomlifyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
