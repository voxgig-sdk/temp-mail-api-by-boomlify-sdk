...
// TempMailApiByBoomlify SDK clienttrack feature
...
class TempMailApiByBoomlifyClienttrackFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    public function PostConstruct(TempMailApiByBoomlifyContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TempMailApiByBoomlify-SDK';
