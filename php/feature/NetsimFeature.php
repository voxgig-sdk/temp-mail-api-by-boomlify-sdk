...
// TempMailApiByBoomlify SDK netsim feature
...
class TempMailApiByBoomlifyNetsimFeature extends TempMailApiByBoomlifyBaseFeature
{
    ...
    private function _simulate(TempMailApiByBoomlifyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TempMailApiByBoomlifyContext $ctx, array $applied): void
    {
        $client = $this->client;
