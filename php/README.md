...
The PHP SDK for the TempMailApiByBoomlify API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Domain(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->TempMailApiByBoomlify(null)->load(
    ["id" => "test01"], null
);
