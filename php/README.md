# TempMailApiByBoomlify PHP SDK



The PHP SDK for the TempMailApiByBoomlify API — an entity-oriented client using PHP conventions.
...
$inbox = $client->Inbox()->load(["id" => "test01", "token" => "example"]);
...
The main class (`tempmailapibyboomlify_sdk.php`) exports the SDK class
