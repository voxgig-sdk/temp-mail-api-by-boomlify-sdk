...
// TempMailApiByBoomlify SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TempMailApiByBoomlifySDK::test)
...
{
    private const SDK_CLASS = 'TempMailApiByBoomlifySDK';
    ...
    private const SDK_BASE = 'tempmailapibyboomlify_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../tempmailapibyboomlify_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
