...
// TempMailApiByBoomlify SDK utility: make_options

class TempMailApiByBoomlifyMakeOptions
{
    ...
    public static function call(TempMailApiByBoomlifyContext $ctx): array
    {
        ...
        //
        // `TempMailApiByBoomlifySchema::optspec()` is built from the model:
        ...
        $optspec = TempMailApiByBoomlifySchema::optspec();
