...
// TempMailApiByBoomlify SDK utility: fetcher

class TempMailApiByBoomlifyFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TempMailApiByBoomlifySDK/1.0)';
    ...
    public static function call(TempMailApiByBoomlifyContext $ctx, string $fullurl, array $fetchdef): array
    {
