# TempMailApiByBoomlify SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TempMailApiByBoomlifySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TempMailApiByBoomlifySDK(...) and TempMailApiByBoomlifySDK.test(...) become
#      TempMailApiByBoomlifySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "tempmailapibyboomlify_sdk"
_SDK_CLASS = "TempMailApiByBoomlifySDK"
